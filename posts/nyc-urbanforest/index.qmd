...
description: "Building an infographic using the 2015 NYC Tree Census"
date: 2026-03-09
categories: [MEDS, R, Data Visualization]
image: treecensus.jpg
citation:
  url: https://avarobillard.github.io/posts/nyc-urbanforest
...
knitr::include_graphics("finalinfographic.png")
```
...
knitr::include_graphics("nyc_species_map.png")
```
...
#| out-width: "80%"
#| fig-alt: "Spatial map of tree species locations."
knitr::include_graphics("info_map.png")
...
knitr::include_graphics("drawing.jpg")
```
...
knitr::include_graphics("incomeviolin.png")
```
